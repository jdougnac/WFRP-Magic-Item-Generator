...
amulet_dict ={
'1': ['Amulet of Thrice-Blessed Copper' ,'One less wounds from impacts with a non-magical weapon, +20 poison resistance, detects poison at 5 cm.', 'CORE1', '183'],
'2': ['Amulet of Adamantine' ,"Increases the user's Toughness to 70. See manual.", 'CORE1', '184'],
'3': ['Amulet of Enchanted Jade' ,"Bearer regenerates like a troll, except they can't regenerate lost limbs or deadly criticals.", 'CORE1', '184'],
'4': ['Amulet of Coal' ,'Can contain up to 3 fireball spells. It recharges by casting Fireball at it.', 'CORE1', '184'],
...
'7': ['Amulet of Law' ,'Gives bonuses to resist Chaotic Magic and pyschological effects from creatures of Chaos. See manual.', 'AN', '42'],
'8': ['Amulet of Watchfulness' ,'If a creature wants to harm the bearer while they sleep, they wake up. See manual.', 'AN', '42']
}
