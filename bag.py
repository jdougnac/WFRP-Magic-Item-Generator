...
bag_dict ={
'1': ['Bag of Lightness' ,'Objects placed in the bag weigh 1/10 their normal weight. Can carry up to 2D6*100 encumbrance points. See manual.', 'AN', '43'],
'2': ['Bag of Middenheim' ,'Like a Bag of Lightness, but it can carry (2D6+3)*100 encumbrance points, and is resistante to fire and water. See manual.', 'AN', '43'],
'3': ['Bag of Resource' ,'Once per day, the bearer can retrieve the necessary materials for a single spell.', 'AN', '43']
}
