...
randomArrowButton = ttk.Button(text='Arrow', command=lambda: insert_text(int(var1.get()), 37))
...
randomArrowButton.grid(row=3, column=2)
...
skillOptionDrop.grid(row=3, column=3)
